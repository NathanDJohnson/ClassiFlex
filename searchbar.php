		...
		<div class="searchblock_out">
			<div class="searchblock">
				<form action="<?php echo home_url( '/' ); ?>" method="get" id="searchform" class="form_search">
					...
					<div class='DropDownField searchbutcat'>
					...
					<div class="searchbutton"><button class="btn_orange" type="submit" tabindex="3" title="<?php _e( 'Search Ads', APP_TD ); ?>" id="go" value="search" name="sa"><?php _e( 'Search Ads', APP_TD ); ?></button></div>
				</form>
